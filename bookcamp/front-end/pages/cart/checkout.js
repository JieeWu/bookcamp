...
export default function Checkout2() {
  ...
  useEffect(() => {
    const data = async () => {
      try {
        await axios
          .get('http://3.113.3.149:3002/cart/checkout', {
  ...
  useEffect(() => {
    if (orderCH.pay == 1) {
      const linepay = async () => {
        try {
          await axios
            .post('http://3.113.3.149:3002/pay/linepay', orderCH, {
              headers: {
                'content-type': 'application/json',
              },
            })
      ...
      const bluepay = async () => {
        try {
          await axios
            .post('http://3.113.3.149:3002/pay/BluePay/list', orderCH, {
              headers: {
                'content-type': 'application/json',
              },
            })
      ...
      const bank = async () => {
        try {
          await axios
            .post('http://3.113.3.149:3002/pay/bankAnd711/bank', orderCH, {
              headers: {
                'content-type': 'application/json',
              },
            })
      ...
      const seven711 = async () => {
        try {
          await axios
            .post('http://3.113.3.149:3002/pay/bankAnd711/seven711', orderCH, {
              headers: {
                'content-type': 'application/json',
              },
            })
